<div class="w-full px-4 py-2 xl:py-4 xl:px-4">
    ...
    <div class="grid w-full grid-cols-1 gap-6 xl:grid-cols-2">
        ...
        <div class="container w-full p-4 mx-auto bg-white rounded-lg shadow-md">
            <h2 class="py-2 mb-4 text-2xl font-semibold text-gray-800">Tabla de usuarios</h2>
        ...
        <!-- Tabla de Productos -->
        <div class="container w-full p-4 mx-auto bg-white rounded-lg shadow-md">
            <h2 class="py-2 mb-4 text-2xl font-semibold text-gray-800">Tabla de productos</h2>
            <div class="w-full overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                    <thead class="bg-gray-200">
                        <tr>
        ...
        <!-- Tabla de ventas -->
        <div class="container w-full p-4 mx-auto bg-white rounded-lg shadow-md">
            <h2 class="py-2 mb-4 text-2xl font-semibold text-gray-800">Tabla de ventas</h2>
            <div class="w-full overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                    <thead class="bg-gray-200">
                        <tr>
        ...
        <!-- Tabla de egresos -->
        <div class="container w-full p-4 mx-auto bg-white rounded-lg shadow-md">
            <h2 class="py-2 mb-4 text-2xl font-semibold text-gray-800">Tabla de egresos</h2>
            <div class="w-full overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                    <thead class="bg-gray-200">
                        <tr>
